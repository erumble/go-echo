...
var GlobalOpts struct {
	LogLevel string `short:"l" long:"log-level" env:"LOG_LEVEL" default:"info" required:"false" description:"The log level to use" choice:"debug" choice:"info" choice:"error"`
}
